...
CREATE INDEX IF NOT EXISTS idx_templates_org_active ON workflow_templates(organization_id, is_active);
...
CREATE INDEX IF NOT EXISTS idx_stages_template ON template_stages(template_id);
...
CREATE INDEX IF NOT EXISTS idx_instances_assigned ON workflow_instances(assigned_to);
CREATE INDEX IF NOT EXISTS idx_instances_current_stage ON workflow_instances(current_stage_id);
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    FOREIGN KEY (from_stage_id) REFERENCES template_stages(id) ON DELETE SET NULL,
    FOREIGN KEY (to_stage_id) REFERENCES template_stages(id) ON DELETE SET NULL
);
